  ...
  return (
    <div className="group bg-white flex flex-col rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 overflow-hidden">
      ...
      <div className="p-5 flex flex-col flex-grow">
        ...
        <h3 className="text-gray-800 font-bold text-lg leading-tight mb-2 line-clamp-1 hover:line-clamp-none transition-all cursor-default">
          {product.title}
        </h3>
        ...
        <div className="flex items-center justify-between mt-auto">
          <div>
            <span className="text-sm text-gray-400 block font-medium">Price</span>
            <span className="text-2xl font-black text-gray-900">₹{product.price}</span>
          </div>
          
          <button
            onClick={addToCart}
            className="bg-gray-900 hover:bg-blue-600 text-white p-3 rounded-xl transition-colors shadow-lg shadow-gray-200"
            title="Add to Cart"
          >
